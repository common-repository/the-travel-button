/*! hwtUIkit 3.6.19 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('uikit', factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.hwtUIkit = factory());
    ...
    var parseCssVar = memoize(function (name) {
        /* usage in css: .hwt-name:before { content:"xyz" } */

        var element = append(document.documentElement, document.createElement('div'));

        addClass(element, ("hwt-" + name));
    ...
    function getCssVar(name) {
        return !isIE
            ? getStyles(document.documentElement).getPropertyValue(("--hwt-" + name))
            : parseCssVar(name);
    }
    ...
    function transition(element, props, duration, timing) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                once(element, 'transitionend transitioncanceled', function (ref) {
                    ...
                    clearTimeout(timer);
                    removeClass(element, 'hwt-transition');
                    css(element, {
                        transitionProperty: '',
                        transitionDuration: '',
                ...
                addClass(element, 'hwt-transition');
                css(element, assign({
    ...
    var Transition = {
        ...
        inProgress: function(element) {
            return hasClass(element, 'hwt-transition');
        }

    };

    var animationPrefix = 'hwt-animation-';
    ...
    function animate$1(element, animation, duration, origin, out) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    origin && addClass(element, ("hwt-transform-origin-" + origin));
    ...
    */
    ...
    function globalAPI (hwtUIkit) {

        var DATA = hwtUIkit.data;

        hwtUIkit.use = function (plugin) {
        ...
        hwtUIkit.mixin = function (mixin, component) {
            component = (isString(component) ? hwtUIkit.component(component) : component) || this;
            component.options = mergeOptions(component.options, mixin);
        };

        hwtUIkit.extend = function (options) {

            options = options || {};

            var Super = this;
            var Sub = function hwtUIkitComponent(options) {
                this._init(options);
            };
        ...
        hwtUIkit.update = function (element, e) {
        ...
        var container;
        Object.defineProperty(hwtUIkit, 'container', {
    ...
    function hooksAPI (hwtUIkit) {

        hwtUIkit.prototype._callHook = function (hook) {
            var this$1 = this;
        ...
        hwtUIkit.prototype._callConnected = function () {
        ...
        hwtUIkit.prototype._callDisconnected = function () {
        ...
        hwtUIkit.prototype._callUpdate = function (e) {
            var this$1 = this;
        ...
        hwtUIkit.prototype._callWatches = function () {
            var this$1 = this;
    ...
    function stateAPI (hwtUIkit) {

        var uid = 0;

        hwtUIkit.prototype._init = function (options) {
        ...
        hwtUIkit.prototype._initData = function () {
        ...
        hwtUIkit.prototype._initMethods = function () {
        ...
        hwtUIkit.prototype._initComputeds = function () {
        ...
        hwtUIkit.prototype._initProps = function (props) {
        ...
        hwtUIkit.prototype._initEvents = function () {
            var this$1 = this;
        ...
        hwtUIkit.prototype._unbindEvents = function () {
            this._events.forEach(function (unbind) { return unbind(); });
            delete this._events;
        };

        hwtUIkit.prototype._initObservers = function () {
            this._observers = [
        ...
        hwtUIkit.prototype._disconnectObservers = function () {
    ...
    function instanceAPI (hwtUIkit) {

        var DATA = hwtUIkit.data;

        hwtUIkit.prototype.$create = function (component, element, data) {
            return hwtUIkit[component](element, data);
        };

        hwtUIkit.prototype.$mount = function (el) {
        ...
        hwtUIkit.prototype.$reset = function () {
            this._callDisconnected();
            this._callConnected();
        };

        hwtUIkit.prototype.$destroy = function (removeEl) {
        ...
        hwtUIkit.prototype.$emit = function (e) {
            this._callUpdate(e);
        };

        hwtUIkit.prototype.$update = function (element, e) {
            if ( element === void 0 ) element = this.$el;

            hwtUIkit.update(element, e);
        };

        hwtUIkit.prototype.$getComponent = hwtUIkit.getComponent;

        var componentName = memoize(function (name) { return hwtUIkit.prefix + hyphenate(name); });
        Object.defineProperties(hwtUIkit.prototype, {

            $container: Object.getOwnPropertyDescriptor(hwtUIkit, 'container'),
    ...
    function componentAPI (hwtUIkit) {

        var DATA = hwtUIkit.data;

        var components = {};

        hwtUIkit.component = function (name, options) {
            ...
            if (!options) {
                ...
                if (isPlainObject(components[name])) {
                    components[name] = hwtUIkit.extend(components[name]);
                }
            ...
            hwtUIkit[name] = function (element, data) {
                var i = arguments.length, argsArray = Array(i);
                while ( i-- ) argsArray[i] = arguments[i];


                var component = hwtUIkit.component(name);
                ...
                function init(element) {
                    ...
                    var instance = hwtUIkit.getComponent(element, name);
            ...
            if (opt.install) {
                opt.install(hwtUIkit, opt, name);
            }

            if (hwtUIkit._initialized && !opt.functional) {
                fastdom.read(function () { return hwtUIkit[name](("[hwt-" + id + "],[data-hwt-" + id + "]")); });
            }

            return components[name] = isPlainObject(options) ? opt : options;
        };

        hwtUIkit.getComponents = function (element) { return element && element[DATA] || {}; };
        hwtUIkit.getComponent = function (element, name) { return hwtUIkit.getComponents(element)[name]; };

        hwtUIkit.connect = function (node) {
        ...
        hwtUIkit.disconnect = function (node) {
            for (var name in node[DATA]) {
    ...
    var getComponentName = memoize(function (attribute) {
        return startsWith(attribute, 'hwt-') || startsWith(attribute, 'data-hwt-')
            ? camelize(attribute.replace('data-hwt-', '').replace('hwt-', ''))
            : false;
    });

    var hwtUIkit = function (options) {
        this._init(options);
    };

    hwtUIkit.util = util;
    hwtUIkit.data = '__uikit__';
    hwtUIkit.prefix = 'hwt-';
    hwtUIkit.options = {};
    hwtUIkit.version = '3.6.19';

    globalAPI(hwtUIkit);
    hooksAPI(hwtUIkit);
    stateAPI(hwtUIkit);
    componentAPI(hwtUIkit);
    instanceAPI(hwtUIkit);

    function Core (hwtUIkit) {
        ...
        on(document, 'animationstart', function (ref) {
            ...
            if ((css(target, 'animationName') || '').match(/^hwt-.*(left|right)/)) {
    ...
    function boot (hwtUIkit) {

        var connect = hwtUIkit.connect;
        var disconnect = hwtUIkit.disconnect;
        ...
        function applyAttributeMutation(ref) {
            ...
            if (!name || !(name in hwtUIkit)) {
                return;
            }

            if (hasAttr(target, attributeName)) {
                hwtUIkit[name](target);
                return;
            }

            var component = hwtUIkit.getComponent(target, name);
    ...
    var Togglable = {
        ...
        data: {
            ...
            origin: false,
            transition: 'linear',
            clsEnter: 'hwt-togglabe-enter',
            clsLeave: 'hwt-togglabe-leave',
    ...
    var Accordion = {
        ...
        data: {
            ...
            multiple: false,
            clsOpen: 'hwt-open',
            toggle: '> .hwt-accordion-title',
            content: '> .hwt-accordion-content',
            transition: 'ease',
            offset: 0
        },
    ...
    var drop = {
        ...
        computed: {
            ...
            clsDrop: function(ref) {
                ...
                return clsDrop || ("hwt-" + (this.$options.name));
            },
    ...
    var Margin = {
        ...
        data: {
            margin: 'hwt-margin-small-top',
            firstColumn: 'hwt-first-column'
        },
    ...
    var grid = {
        ...
        data: {
            margin: 'hwt-grid-margin',
            clsStack: 'hwt-grid-stack',
            masonry: false,
            parallax: 0
        },

        connected: function() {
            this.masonry && addClass(this.$el, 'hwt-flex-top hwt-flex-wrap-top');
        },
    ...
    function applyAnimation(el) {
        ...
        if (length) {
            el.style.setProperty('--hwt-animation-stroke', length);
        }
    ...
    var Slidenav = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'hwt-slidenav-large')
                    ? (icon + "-large")
                    : icon;
            }
    ...
    var Search = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'hwt-search-icon') && parents($el, '.hwt-search-large').length
                    ? 'search-large'
                    : parents($el, '.hwt-search-navbar').length
                        ? 'search-navbar'
                        : icon;
            }
    ...
    var Close = {
        ...
        computed: {
            ...
            icon: function() {
                return ("close-" + (hasClass(this.$el, 'hwt-close-large') ? 'large' : 'icon'));
            }
    ...
    var parsed = {};
    function install$3(hwtUIkit) {
        hwtUIkit.icon.add = function (name, svg) {
            var obj;
            ...
            if (hwtUIkit._initialized) {
                apply$1(document.body, function (el) { return each(hwtUIkit.getComponents(el), function (cmp) {
    ...
    var leader = {
        ...
        data: {
            fill: '',
            clsWrapper: 'hwt-leader-fill',
            clsHide: 'hwt-leader-hide',
            attrFill: 'data-fill'
        },
    ...
    var modal = {
        ...
        data: {
            clsPage: 'hwt-modal-page',
            selPanel: '.hwt-modal-dialog',
            selClose: '.hwt-modal-close, .hwt-modal-close-default, .hwt-modal-close-outside, .hwt-modal-close-full'
        },
        ...
        events: [

            {
                ...
                handler: function() {
                    ...
                    if (hasClass(this.panel, 'hwt-margin-auto-vertical')) {
                        addClass(this.$el, 'hwt-flex');
                    } else {
    ...
    function install$2(ref) {
        ...
        modal.dialog = function (content, options) {
            ...
            var dialog = modal(
                ("<div class=\"hwt-modal\"> <div class=\"hwt-modal-dialog\">" + content + "</div> </div>"),
                options
            );
        ...
        modal.alert = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<div class=\"hwt-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"hwt-modal-footer hwt-text-right\"> <button class=\"hwt-button hwt-button-primary hwt-modal-close\" autofocus>" + (labels.ok) + "</button> </div>");
            },
                options,
        ...
        modal.confirm = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form> <div class=\"hwt-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"hwt-modal-footer hwt-text-right\"> <button class=\"hwt-button hwt-button-default hwt-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"hwt-button hwt-button-primary\" autofocus>" + (labels.ok) + "</button> </div> </form>");
            },
                options,
        ...
        modal.prompt = function (message, value, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form class=\"hwt-form-stacked\"> <div class=\"hwt-modal-body\"> <label>" + (isString(message) ? message : html(message)) + "</label> <input class=\"hwt-input\" value=\"" + (value || '') + "\" autofocus> </div> <div class=\"hwt-modal-footer hwt-text-right\"> <button class=\"hwt-button hwt-button-default hwt-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"hwt-button hwt-button-primary\">" + (labels.ok) + "</button> </div> </form>");
            },
                options,
    ...
    var navbar = {
        ...
        data: {
            dropdown: '.hwt-navbar-nav > li',
            align: !isRtl ? 'left' : 'right',
            clsDrop: 'hwt-navbar-dropdown',
            mode: undefined,
            offset: undefined,
            delayShow: undefined,
            delayHide: undefined,
            ...
            duration: 200,
            forceHeight: true,
            selMinHeight: '.hwt-navbar-nav > li > a, .hwt-navbar-item, .hwt-navbar-toggle'
        },
        ...
        computed: {
            ...
            dropbar: {
                ...
                get: function(ref) {
                    ...
                    dropbar = this._dropbar || query(dropbar, this.$el) || $('+ .hwt-navbar-dropbar', this.$el);
                ...
                watch: function(dropbar) {
                    addClass(dropbar, 'hwt-navbar-dropbar');
                },
...

            {
                ...
                handler: function(_, ref) {
                    ...
                    if (this.dropbarMode === 'slide') {
                        addClass(this.dropbar, 'hwt-navbar-dropbar-slide');
                    }
    ...
    var offcanvas = {
        ...
        data: {
            ...
            flip: false,
            overlay: false,
            clsPage: 'hwt-offcanvas-page',
            clsContainer: 'hwt-offcanvas-container',
            selPanel: '.hwt-offcanvas-bar',
            clsFlip: 'hwt-offcanvas-flip',
            clsContainerAnimation: 'hwt-offcanvas-container-animation',
            clsSidebarAnimation: 'hwt-offcanvas-bar-animation',
            clsMode: 'hwt-offcanvas',
            clsOverlay: 'hwt-offcanvas-overlay',
            selClose: '.hwt-offcanvas-close',
            container: false
        },
    ...
    var overflowAuto = {
        ...
        data: {
            selContainer: '.hwt-modal',
            selContent: '.hwt-modal-dialog'
        },
    ...
    var responsive = {
        ...
        connected: function() {
            addClass(this.$el, 'hwt-responsive-width');
        },
    ...
    var scrollspy = {
        ...
        data: function () { return ({
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'hwt-scrollspy-inview'
        }); },
...

            {
                ...
                read: function(data$1) {
                    ...
                    this.elements.forEach(function (el) {
                        ...
                        if (!el[stateKey]) {
                            el[stateKey] = {cls: data(el, 'hwt-scrollspy-class') || this$1.cls};
                        }
    ...
    var sticky = {
        ...
        data: {
            ...
            offset: 0,
            animation: '',
            clsActive: 'hwt-active',
            clsInactive: '',
            clsFixed: 'hwt-sticky-fixed',
            clsBelow: 'hwt-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            targetOffset: false
        ...
        connected: function() {
            this.placeholder = $('+ .hwt-sticky-placeholder', this.$el) || $('<div class="hwt-sticky-placeholder"></div>');
            this.isFixed = false;
            this.isActive = false;
        },
    ...
    var Switcher = {
        ...
        data: {
            connect: '~.hwt-switcher',
            toggle: '> * > :first-child',
            active: 0,
            swiping: true,
            cls: 'hwt-active',
            attrItem: 'hwt-switcher-item'
        },
        ...
        computed: {
            ...
            toggles: {
                ...
                get: function(ref, $el) {
                    ...
                    return $$(toggle, $el).filter(function (el) { return !matches(el, '.hwt-disabled *, .hwt-disabled, [disabled]'); });
                },
    ...
    var tab = {
        ...
        data: {
            media: 960,
            attrItem: 'hwt-tab-item'
        },

        connected: function() {

            var cls = hasClass(this.$el, 'hwt-tab-left')
                ? 'hwt-tab-left'
                : hasClass(this.$el, 'hwt-tab-right')
                    ? 'hwt-tab-right'
                    : false;
    ...
    // register components
    each(components$1, function (component, name) { return hwtUIkit.component(name, component); }
    );
    ...
    var clsLeave = 'hwt-transition-leave';
    var clsEnter = 'hwt-transition-enter';
    ...
    function fade(action, target, duration, stagger) {
        ...
        var enterFn = wrapIndexFn(function () {
            ...
            // Ensure hwtUIkit updates have propagated
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'hwt-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var Slideshow = {
        ...
        data: {
            animation: 'slide',
            clsActivated: 'hwt-transition-active',
    ...
    var LightboxPanel = {
        ...
        data: function () { return ({
            ...
            items: [],
            cls: 'hwt-open',
            clsPage: 'hwt-lightbox-page',
            selList: '.hwt-lightbox-items',
            attrItem: 'hwt-lightbox-item',
            selClose: '.hwt-close-large',
            selCaption: '.hwt-lightbox-caption',
            pauseOnHover: false,
            velocity: 2,
            Animations: Animations$1,
            template: "<div class=\"hwt-lightbox hwt-overflow-hidden\"> <ul class=\"hwt-lightbox-items\"></ul> <div class=\"hwt-lightbox-toolbar hwt-position-top hwt-text-right hwt-transition-slide-top hwt-transition-opaque\"> <button class=\"hwt-lightbox-toolbar-icon hwt-close-large\" type=\"button\" hwt-close></button> </div> <a class=\"hwt-lightbox-button hwt-position-center-left hwt-position-medium hwt-transition-fade\" href hwt-slidenav-previous hwt-lightbox-item=\"previous\"></a> <a class=\"hwt-lightbox-button hwt-position-center-right hwt-position-medium hwt-transition-fade\" href hwt-slidenav-next hwt-lightbox-item=\"next\"></a> <div class=\"hwt-lightbox-toolbar hwt-lightbox-caption hwt-position-bottom hwt-text-center hwt-transition-slide-bottom hwt-transition-opaque\"></div> </div>"
        }); },
        ...
        events: [
...

            {
                ...
                handler: function(_, item) {
                    ...
                    this.setItem(item, '<span hwt-spinner></span>');
        ...
        methods: {
            ...
            setError: function(item) {
                this.setItem(item, '<span hwt-icon="icon: bolt; ratio: 2"></span>');
            },
            ...
            showControls: function() {
                ...
                addClass(this.$el, 'hwt-active', 'hwt-transition-active');

            },

            hideControls: function() {
                removeClass(this.$el, 'hwt-active', 'hwt-transition-active');
            }
    ...
    var lightbox = {
        ...
        events: [

            {
                ...
                delegate: function() {
                    return ((this.toggle) + ":not(.hwt-disabled)");
                },
    ...
    function install$1(hwtUIkit, Lightbox) {

        if (!hwtUIkit.lightboxPanel) {
            hwtUIkit.component('lightboxPanel', LightboxPanel);
        }

        assign(
            Lightbox.props,
            hwtUIkit.component('lightboxPanel').options.props
        );
    ...
    var notification = {
        ...
        data: {
            ...
            group: null,
            pos: 'top-center',
            clsContainer: 'hwt-notification',
            clsClose: 'hwt-notification-close',
            clsMsg: 'hwt-notification-message'
        },
        ...
        created: function() {
            ...
            this.$mount(append(container,
                ("<div class=\"" + (this.clsMsg) + (this.status ? (" " + (this.clsMsg) + "-" + (this.status)) : '') + "\"> <a href class=\"" + (this.clsClose) + "\" data-hwt-close></a> <div>" + (this.message) + "</div> </div>")
            ));
    ...
    function install(hwtUIkit) {
        hwtUIkit.notification.closeAll = function (group, immediate) {
            apply$1(document.body, function (el) {
                var notification = hwtUIkit.getComponent(el, 'notification');
    ...
    var slider = {
        ...
        data: {
            center: false,
            sets: false,
            attrItem: 'hwt-slider-item',
            selList: '.hwt-slider-items',
            selNav: '.hwt-slider-nav',
            clsContainer: 'hwt-slider-container',
    ...
    var slideshow = {
        ...
        data: {
            ...
            minHeight: false,
            maxHeight: false,
            selList: '.hwt-slideshow-items',
            attrItem: 'hwt-slideshow-item',
            selNav: '.hwt-slideshow-nav',
    ...
    var sortable = {
        ...
        data: {
            group: false,
            threshold: 5,
            clsItem: 'hwt-sortable-item',
            clsPlaceholder: 'hwt-sortable-placeholder',
            clsDrag: 'hwt-sortable-drag',
            clsDragState: 'hwt-drag',
            clsBase: 'hwt-sortable',
            clsNoDrag: 'hwt-sortable-nodrag',
            clsEmpty: 'hwt-sortable-empty',
            clsCustom: '',
            handle: false,
            pos: {}
        },
    ...
    var tooltip = {
        ...
        data: {
            ...
            title: '',
            delay: 0,
            animation: ['hwt-animation-scale-up'],
            duration: 100,
            cls: 'hwt-active',
            clsPos: 'hwt-tooltip'
        },
    ...
    each(components, function (component, name) { return hwtUIkit.component(name, component); }
    );
